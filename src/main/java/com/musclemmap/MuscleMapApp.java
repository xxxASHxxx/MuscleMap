...
public class MuscleMapApp extends Application {
    @Override
    public void start(Stage stage) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(MuscleMapApp.class.getResource("/fxml/login.fxml"));
        Scene scene = new Scene(fxmlLoader.load(), 1200, 800);

        // Load CSS file
        try {
            String cssFile = MuscleMapApp.class.getResource("/css/styles.css").toExternalForm();
